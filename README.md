...
to set up a service worker you have to basically copy [the example](https://github.com/omegion1npm/nemo-dicta-expedita/tree/master/example/sw.js) and register it:
